...
class AdapterArguments:
    ...
    train_adapter: bool = field(default=False, metadata={
                                "help": "Choose whether to train LoRA adapter"})
    lora_alpha: int = field(default=16, metadata={
                            "help": "Alpha value for LoRA layers"})
    lora_dropout: float = field(default=0.1, metadata={
                                "help": "Dropout rate for LoRA layers"})
    lora_rank: int = field(default=4, metadata={
                           "help": "Rank for LoRA projection"})
    lora_bias: str = field(default="none", metadata={
                           "help": "Bias to use for LoRA"})
    adalora_init_r: int = field(default=12, metadata={
                            "help": "The initial rank for each incremental matrix"})
    adalora_tinit: str = field(default=200, metadata={
                           "help": "The steps of initial fine-tuning warmup"})
    adalora_tfinal: str = field(default=1000, metadata={
                           "help": "The step of final fine-tuning"})
    adalora_deltaT: str = field(default=10, metadata={
...
def main():
    ...
    if adapter_args.lora or adapter_args.adalora:
